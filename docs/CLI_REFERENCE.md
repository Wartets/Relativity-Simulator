...
| `ray_steps`, `steps_limit` | Integer | Maximum integration steps per ray (64 to 16384). | `set ray_steps 2048` |
| `performance`, `perf` | Integer | Performance profile preset (0 to 4). | `set performance 2` |
| `camera_mode`, `cam_mode` | Integer | Mode (0: Free Fly, 1: Orbit, 2: Spherical, 3: Cockpit). | `set camera_mode 0` |
